...
fn run_impl() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::config::openai_skills::openai_skills_list,
            commands::config::openai_skills::openai_skills_detail,
            commands::config::openai_skills::openai_skills_install,
            ...
            commands::pool::list_pool_members,
            commands::pool::add_pool_member,
            commands::pool::remove_pool_member,
